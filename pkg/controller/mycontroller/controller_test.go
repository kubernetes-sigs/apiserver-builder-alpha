...
import (
	...
	. "github.com/kubernetes-incubator/apiserver-builder-example/pkg/client/clientset_generated/clientset/typed/simple/v1alpha1"
...
var _ = Describe("MyController controller", func() {
	var instance MyController
	var expectedKey string
	var client MyControllerInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "mycontroller-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.SimpleV1alpha1Client.MyControllers("mycontroller-controller-test-handler")
