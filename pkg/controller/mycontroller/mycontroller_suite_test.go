...
import (
	...
	"github.com/kubernetes-incubator/apiserver-builder-example/pkg/controller/mycontroller"
)
...
var controller *mycontroller.MyControllerController
var si *sharedinformers.SharedInformers

func TestMyController(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "MyController Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = mycontroller.NewMyControllerController(config, si)
