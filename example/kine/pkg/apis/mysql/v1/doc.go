...
// +k8s:conversion-gen=sigs.k8s.io/apiserver-builder-alpha/example/kine/pkg/apis/mysql
// +k8s:defaulter-gen=TypeMeta
// +groupName=mysql.example.com
package v1 // import "sigs.k8s.io/apiserver-builder-alpha/example/kine/pkg/apis/mysql/v1"
