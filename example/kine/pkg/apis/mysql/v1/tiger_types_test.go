...
import (
	...
	. "sigs.k8s.io/apiserver-builder-alpha/example/kine/pkg/apis/mysql/v1"
	. "sigs.k8s.io/apiserver-builder-alpha/example/kine/pkg/client/clientset_generated/clientset/typed/mysql/v1"
)

var _ = Describe("Tiger", func() {
	var instance Tiger
	var expected Tiger
	var client TigerInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.MysqlV1().Tigers("tiger-test-valid")
