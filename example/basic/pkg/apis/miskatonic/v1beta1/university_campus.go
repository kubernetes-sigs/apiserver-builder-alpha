...
var _ resource.GetterUpdaterSubResource = &UniversityCampus{}
...
func (in *UniversityCampus) Get(ctx context.Context, name string, options *metav1.GetOptions) (runtime.Object, error) {
	...
	university, err := parentStorage.Get(ctx, name, options)
	if err != nil {
		return nil, err
	}
	return &UniversityCampus{
		Faculty: university.(*University).Spec.FacultySize,
	}, nil
}
