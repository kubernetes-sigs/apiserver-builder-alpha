...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.Pod":         schema_pkg_apis_podlogs_v1_Pod(ref),
		"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodList":     schema_pkg_apis_podlogs_v1_PodList(ref),
		"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodLogs":     schema_pkg_apis_podlogs_v1_PodLogs(ref),
		"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodLogsList": schema_pkg_apis_podlogs_v1_PodLogsList(ref),
		"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodSpec":     schema_pkg_apis_podlogs_v1_PodSpec(ref),
		"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodStatus":   schema_pkg_apis_podlogs_v1_PodStatus(ref),
	}
}
...
func schema_pkg_apis_podlogs_v1_Pod(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Pod",
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodSpec", "sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodStatus"},
	}
}

func schema_pkg_apis_podlogs_v1_PodList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.Pod"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.Pod"},
	}
}

func schema_pkg_apis_podlogs_v1_PodLogs(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				...
				Required: []string{"Container", "Follow", "Previous", "SinceSeconds", "SinceTime", "Timestamps", "TailLines", "LimitBytes"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_podlogs_v1_PodLogsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodLogs"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/apis/podlogs/v1.PodLogs"},
	}
}

func schema_pkg_apis_podlogs_v1_PodSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_podlogs_v1_PodStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
