...
import (
	...
	"sigs.k8s.io/apiserver-builder-alpha/example/podlogs/pkg/client/clientset_generated/clientset/scheme"
)

type PodlogsV1Interface interface {
...
func (c *PodlogsV1Client) PodLogses(namespace string) PodLogsInterface {
	return newPodLogses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*PodlogsV1Client, error) {
	...
	return &PodlogsV1Client{client}, nil
}

// NewForConfigOrDie creates a new PodlogsV1Client for the given config and
