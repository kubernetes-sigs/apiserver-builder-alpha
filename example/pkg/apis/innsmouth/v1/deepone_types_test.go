...
import (
	...
	. "sigs.k8s.io/apiserver-builder-alpha/example/pkg/apis/innsmouth/v1"
	. "sigs.k8s.io/apiserver-builder-alpha/example/pkg/client/clientset_generated/clientset/typed/innsmouth/v1"
