...
import (
	...
	. "sigs.k8s.io/apiserver-builder-alpha/example/pkg/apis/kingsport/v1"
	. "sigs.k8s.io/apiserver-builder-alpha/example/pkg/client/clientset_generated/clientset/typed/kingsport/v1"
)
