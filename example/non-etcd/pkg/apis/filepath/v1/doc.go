...
// +k8s:conversion-gen=sigs.k8s.io/apiserver-builder-alpha/example/non-etcd/pkg/apis/filepath
// +k8s:defaulter-gen=TypeMeta
// +groupName=filepath.example.com
package v1 // import "sigs.k8s.io/apiserver-builder-alpha/example/non-etcd/pkg/apis/filepath/v1"
