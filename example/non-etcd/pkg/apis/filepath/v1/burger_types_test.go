...
import (
	...
	. "sigs.k8s.io/apiserver-builder-alpha/example/non-etcd/pkg/apis/filepath/v1"
	. "sigs.k8s.io/apiserver-builder-alpha/example/non-etcd/pkg/client/clientset_generated/clientset/typed/filepath/v1"
)

var _ = Describe("Burger", func() {
	var instance Burger
	var expected Burger
	var client BurgerInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.FilepathV1().Burgers("burger-test-valid")
