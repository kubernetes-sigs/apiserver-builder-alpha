...
import (
	...
	storagecontrollers "example.io/controllers/storage"
...
func main() {
	...
	if err = (&storagecontrollers.SnapshotClaimReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SnapshotClaim")
		os.Exit(1)
	}
